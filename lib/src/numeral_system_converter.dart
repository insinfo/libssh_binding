...
class NumeralSystemConverter {
  static String decimalToBinary(double input) {
    String result = "";
    int x = (input).toInt();
    do {
      result += (x % 2).toString();
  ...
  static String decimalToOctal(double input) {
    String result = "";
    int x = input.toInt();
    do {
      result += (x % 8).toString();
  ...
  static String decimalToOctal2(int input) {
    String result = "";
    int x = input;
    do {
      result += (x % 8).toString();
  ...
  static String decimalToHexa(double input) {
  ...
  static String hexaToDecimal(String input) {
